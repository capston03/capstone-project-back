...
namespace_thumbnail = Namespace('thumbnail', 'Api for sticker')
INDEX_THUMBNAIL_PATH: Final = 3
...
class Download(Resource):
    def post(self):
        ...
        return to_json({"download_url": s3_handler.generate_download_url(sticker[INDEX_THUMBNAIL_PATH])})
